$(function () {
  fetch(`https://dapi.kakao.com/v3/search/book?query=바보&size=12`, {
    headers: {
    ...
    .then((data) => {
      ...
      document
        .querySelector(".detailtrendbook .nextbutton1")
      ...
      document
        .querySelector(".detailtrendbook .prevbutton1")
        .addEventListener("click", () => {
          if (currentIndex > 0) {
            currentIndex--;
          } else {
